...
public final class DocumentsIasi implements Runnable {
    ...
    private static final URI CONTEXT=DOCUMENTS.id().resolve("iasi");

    private static final String DATA_URL="documents-iasi-url"; // vault label
    ...
    public void run() {
        ...
        store.partition(CONTEXT).clear().insert(array(list(Stream.of(url)
                ...
                .flatMap(new Documents.Loader(University.IASI))
