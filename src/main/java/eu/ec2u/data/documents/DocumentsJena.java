...
public final class DocumentsJena implements Runnable {
    ...
    private static final URI CONTEXT=DOCUMENTS.id().resolve("jena");

    private static final String DATA_URL="documents-jena-url"; // vault label
    ...
    public void run() {
        ...
        store.partition(CONTEXT).clear().insert(array(list(Stream.of(url)
                ...
                .flatMap(new Documents.Loader(University.JENA))
