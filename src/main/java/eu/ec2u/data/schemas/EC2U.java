...
public final class EC2U {
	...
	public static final Map<String, Frame> Universities=unmodifiableMap(Stream.of(
			...
			frame(iri(Base, "/universities/1")).value(RDF.TYPE, University)
					...
					.value(RDFS.LABEL, literal("University of Coimbra"))
			...
			frame(iri(Base, "/universities/2")).value(RDF.TYPE, University)
					...
					.value(RDFS.LABEL, literal("University of Iasi"))
					.value(RDFS.COMMENT, literal("Alexandru Ioan Cuza University of Iasi, the first modern "
							...
							+ "universities "
							+"in terms of research, education and institutional transparency. With about 23000 students"
							+ " and "
							+"2000 full-time staff in its 15 faculties, our university’s academic offer includes 80 "
							+ "degrees at"
							+" bachelor level (4 in English, 1 in French), 116 master level programmes (14 in English, "
							+ "1 in "
			...
			frame(iri(Base, "/universities/3")).value(RDF.TYPE, University)
					...
					.value(RDFS.LABEL, literal("University of Jena"))
			...
			frame(iri(Base, "/universities/4")).value(RDF.TYPE, University)
					...
					.value(RDFS.LABEL, literal("University of Pavia"))
			...
			frame(iri(Base, "/universities/5")).value(RDF.TYPE, University)
					...
					.value(RDFS.LABEL, literal("University of Poitiers"))
			...
			frame(iri(Base, "/universities/6")).value(RDF.TYPE, University)
					...
					.value(RDFS.LABEL, literal("University of Salamanca"))
					.value(RDFS.COMMENT, literal("The University of Salamanca was founded in 1218 and is one of the"
							+" three oldest universities in Europe, boasting a wide range of Faculties and Research "
							+ "Institutes"
							+" in Sciences and Arts. In 2011, it was awarded the Campus of International Excellence "
							+ "status. It"
							+" is the university of reference in its region and beyond (Castile and León) and the “Alma"
							+ " Mater”"
							+" of nearly all historical Latin American universities.", "en")),
			...
			frame(iri(Base, "/universities/7")).value(RDF.TYPE, University)
					...
					.value(RDFS.LABEL, literal("University of Turku"))
