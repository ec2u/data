...
public final class EC2U {
	...
	public static final Map<String, Frame> Universities=unmodifiableMap(Stream.of(
			...
			frame(iri(Base, "/universities/1")).set(RDF.TYPE).value(University)
			...
			frame(iri(Base, "/universities/2")).set(RDF.TYPE).value(University)
					...
					+"French) and 27 fields of study at the doctoral level (all offered in English as well).", "en")),

			frame(iri(Base, "/universities/3")).set(RDF.TYPE).value(University)
			...
			frame(iri(Base, "/universities/4")).set(RDF.TYPE).value(University)
			...
			frame(iri(Base, "/universities/5")).set(RDF.TYPE).value(University)
			...
			frame(iri(Base, "/universities/6")).set(RDF.TYPE).value(University)
			...
			frame(iri(Base, "/universities/7")).set(RDF.TYPE).value(University)
