...
public final class EventsPoitiersUniversity implements Runnable {
    ...
    private static final URI PIPELINE=uri("java:%s".formatted(EventsPoitiersUniversity.class.getName()));
    ...
    public void run() {
        time(() -> Stream
                ...
                .flatMap(traverse(
                        ...
                        path -> path.links("//div[@class='wp-pagenavi']//a/@href"),
                        path -> path.links("//li[@class='post']/a/@href")
