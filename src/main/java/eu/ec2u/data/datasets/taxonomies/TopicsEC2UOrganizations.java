...
public final class TopicsEC2UOrganizations implements Runnable {
    ...
    private static final String DATA_URL="taxonomies-ec2u-organizations"; // vault label
    ...
    @Override public void run() {
        service(store()).modify(
                ...
                array(list(Xtream.from(
                        Stream.of(EC2U_ORGANIZATIONS),
                        Stream.of(vault.get(DATA_URL)).flatMap(new Taxonomies.Loader(EC2U_ORGANIZATIONS))
                ))),
