...
public final class TopicsEC2UDocuments implements Runnable {

    private static final String DATA_URL="taxonomies-ec2u-documents"; // vault label


    public static final String PATH=Taxonomies.PATH+"documents/";
    ...
    public static void main(final String... args) {
        exec(() -> new TopicsEC2UDocuments().run());
    }
    ...
    @Override public void run() {
        service(store()).modify(
                ...
                array(list(Xtream.from(
                        Stream.of(EC2U_DOCUMENTS),
                        Stream.of(vault.get(DATA_URL)).flatMap(new Taxonomies.Loader(EC2U_DOCUMENTS))
                ))),
