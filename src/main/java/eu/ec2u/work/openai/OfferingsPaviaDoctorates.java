...
public final class OfferingsPaviaDoctorates implements Runnable {
    ...
    @Override public void run() {
        ...
        final String key=vault
                .get("openai-key")
                .orElseThrow(() -> new IllegalStateException(format(
                        "undefined API key <%s>", "openai-key"
                )));

        final List<Frame> doctorates=doctorates(key);
    ...
    private static List<Frame> doctorates(final String key) {
        return Xtream.of(PageURL)
                ...
                .optMap(new OpenAI("gpt-4o-mini", key)
                ...
                .flatMap(json -> json.paths("programs.*"))
    ...
    private static Xtream<Frame> doctorate(final String key, final String url) {
