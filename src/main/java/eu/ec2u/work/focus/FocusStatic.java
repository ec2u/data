...
final class FocusStatic implements Focus {

    private final Set<Value> values;


    FocusStatic(final Set<Value> values) { this.values=values; }


    @Override public Stream<Focus> split() {
        return values.stream().map(value -> new FocusStatic(Set.of(value)));
    }
