	...
	return (
		...
		>
			...
			<Custom tag="tool-home">
				...
				<ul>
					<li><span>7</span><Link href="/universities/"><MapPin/></Link><span>Universities</span></li>
					...
					<li><span>567'890</span><Link href="/structures/"><BookOpen/></Link><span>Publications</span></li>
				</ul>
