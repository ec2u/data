...
| [foaf:depiction](http://xmlns.com/foaf/spec/#term_depiction) | uri                           | * | links to visual representations of the agent                       |
| [foaf:homepage](http://xmlns.com/foaf/spec/#term_homepage)   | uri                           | * | links to public main web pages for the agent                       |
...
| [org:classification](https://www.w3.org/TR/vocab-org/#org:classification)         | [skos:Concept](taxonomies.md#concept)          | *    | links to organization types in the [/concepts/organizations](/concepts/organizations) taxonomy                                               |
