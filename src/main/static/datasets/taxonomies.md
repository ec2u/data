...
|-------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------|---|---------------------------------------------|
| **ec2u:Taxonomy**                                                 | [ec2u:Dataset](./index.md#dataset), [skos:ConceptScheme](../about/vocabularies/skos.md#concept-scheme) |   | EC2U Knowledge Hub classification taxonomy  |
...
| term                                                             | type                                                                                        | #    | description                                                            |
|------------------------------------------------------------------|---------------------------------------------------------------------------------------------|------|------------------------------------------------------------------------|
| **ec2u:Topic**                                                   | [ec2u:Resource](./index.md#resource), [skos:Concept](../about/vocabularies/skos.md#concept) |      | Concept included in a [classification taxonomy](#taxonomy)             |
