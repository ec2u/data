...
EC2U collections are described using a controlled subset
of
...
![collection data model](index/collections.svg#75)
...
> [!WARNING]
> Published collections, that is collections that specify a `dct:issued` date, must also include at least
> one `dct:license`.
